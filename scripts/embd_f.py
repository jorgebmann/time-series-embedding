...
def features_tda(df_list):
    features = []
    for df in df_list:
        features.append(feature_vector(df))
    return features
...
def TDA_embedding(x_train, x_val, x_test):
    ...
    train_tda=merging(x_train_a1,x_train_a2,x_train_a22,x_train_a3, x_train_a32)
    ...
    val_tda=merging(x_val_a1,x_val_a2,x_val_a22,x_val_a3, x_val_a32)
    ...
    test_tda=merging(x_test_a1,x_test_a2,x_test_a22,x_test_a3, x_test_a32)
